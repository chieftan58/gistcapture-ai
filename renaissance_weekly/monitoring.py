...
class SystemMonitor:
    ...
    def record_success(self, component: str, podcast: str = "system"):
    ...
    def record_failure(self, component: str, podcast: str, episode_title: str, 
        ...
        self._check_alerts(component, podcast)
    ...
    def _calculate_health_score(self) -> str:
        ...
        avg_success_rate = sum(s.success_rate for s in self.component_stats.values()) / max(len(self.component_stats), 1)
        
        if recent_failures < 5 and avg_success_rate > 0.9:
            return "🟢 Healthy"
        elif recent_failures < 10 and avg_success_rate > 0.7:
            return "🟡 Warning"
        else:
            return "🔴 Critical"
    
    def _check_alerts(self, component: str, podcast: str):
